...
detectLinks: false,
	...
	//group target \\
const reply = (teks) => {
           XeonBotInc.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": ` ${global.botname}`,"body": `${ownername}`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./XeonMedia/theme/th.jpg`),"sourceUrl": `${linkz}`}}}, { quoted: m})
        }
...
if (!args[0]) return m.reply(`bot git link
https://github.com/acedemy/DARK-NA-V2
my Whatsapp nomber
...
reply(`•DARK-NA BOT DEVELOPER•\n\n\n   ©2022-2023 Nilambara\n\n🦄Nilambara\nPm: wa.me/94756224020`)
}
            break
...
teks = `*「 DARK-NA-V2 Script 」*\n\nYouTube: https://www.youtube.com/channel/UCBbXJI6DPbmXDuWkHk819pw\nGitHub: ${global.botscript}\n\nDont forget to donate 🍜`
let buttons = [
{buttonId: `owner`, buttonText: {displayText: 'Owner 🌺'}, type: 1}
]
let buttonMessage = {
image: {url: `https://i.ibb.co/CwzQXqD/th.jpg`},
jpegThumbnail: log0,
caption: teks,
footer: `${botname}`,
//buttons: buttons,
...
thumbnail: fs.readFileSync("XeonMedia/theme/th.jpg"),
mediaType:1,
mediaUrl: 'https://i.ibb.co/CwzQXqD/th.jpg',
sourceUrl: "https://i.ibb.co/CwzQXqD/th.jpg"
}}
}
XeonBotInc.sendMessage(m.chat, buttonMessage, { quoted: m })
}
...
"businessOwnerJid": "94756224020@s.whatsapp.net",
}
...
amount = `${encodeURI(q)}`
for (let i = 0; i < amount; i++) {
XeonBotInc.sendMessage(m.chat, { image: { url: 'https://i.ibb.co/CwzQXqD/th.jpg' }, caption: `${ownername} ${iphone}` }, { quoted: doc })
}
}
break
case 'iosvirtex5': {
...
amount = `${encodeURI(q)}`
for (let i = 0; i < amount; i++) {
XeonBotInc.sendMessage(m.chat, { image: { url: 'https://i.ibb.co/CwzQXqD/th.jpg' }, caption: `${ownername} ${iphone5}` }, { quoted: doc })
}
}
break
case '🌷':{
...
"message": ownername,
"orderTitle": wm, // 
"sellerJid": " 0756224020@s.whatsapp.net",
...
└┬────────────┈ ⳹
 ...
 case 'menu': {
            let ownerny = ownernomer + '@s.whatsapp.net'
            let me = m.sender
            let timestamp = speed();
            let latensi = speed() - timestamp
            let xeonezy = `┌─❖
